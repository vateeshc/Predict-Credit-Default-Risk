...
data_h2o$fold <- h2o.kfold_column(data_h2o, 5, seed = 1234)
te_map <- h2o.target_encode_create(data_h2o, x = te_cols, y = "TARGET" , fold_column = "fold")
...
```{r}
ext_train_h2o <- h2o.target_encode_apply(data_h2o, x = te_cols, y = "TARGET",
                                     target_encode_map = te_map, 
                                     holdout_type = "KFold"
                                     fold_column = "fold",
                                     blended_avg = TRUE, noise_level = 0
                                     , seed = 1234
                                     )
...
TE not needed for the validate & testing data due to CV used on all train data:
...
Train model with KFold target encoding. Replace Categorical with TargetEncoded variables.

```{r}
y <- "TARGET"
x <- setdiff(names(ext_train_h2o), c(y, te_cols))
...
automl_models_h2o <- h2o.automl(
    ...
    max_runtime_secs  = 900,
       model_id = "cv_te_autoML_20180829_001",
# Early Stopping
